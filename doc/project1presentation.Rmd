...
In the both plot, positive words account for a larger area. In *recession* part, positve words have a slightly larger proportion in speeches compared with *not in recession* part. For a clearer comparison, I generate the following plots.
